...
``export_xlsx=True`` when calling ``create_table``.

A small pytest suite is included. Run the tests and a quick syntax check from
...
Running both commands ensures the project compiles cleanly and tests continue to
pass.
